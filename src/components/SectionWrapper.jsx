...
function SectionWrapper({ children, header, title, sectionId }) {
    return (
        <section id={sectionId} className="flex flex-col min-h-screen gap-10">
            ...
            <div className="max-w-[1024px] w-full flex flex-col mx-auto gap-10 p-4">
                {children}
            </div>
        </section>
    )
